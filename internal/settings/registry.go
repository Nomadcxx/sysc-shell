...
func DefaultFor(cfg config.Config) *Registry {
	r := &Registry{entries: []Entry{
		...
		{
			Path: "bar.style", Label: "Style", Section: "Bar", Group: "Surface", Kind: KindEnum,
		...
		{
			Path: "bar.shape", Label: "Shape", Section: "Bar", Group: "Surface", Kind: KindEnum,
		...
		{
			Path: "bar.frost-opacity", Label: "Frost opacity", Section: "Bar", Group: "Frost",
		...
		{
			Path: "bar.pill-opacity", Label: "Pill opacity", Section: "Bar", Group: "Frost",
