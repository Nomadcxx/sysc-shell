...
func DefaultTheme() Theme {
	return Theme{
		...
		Capsule:     Color{R: 0x18, G: 0x1a, B: 0x1d, A: 0xff},
		Container:   Color{R: 0x00, G: 0x3a, B: 0x75, A: 0xff},
		OnAccent:    Color{R: 0xff, G: 0xff, B: 0xff, A: 0xff},
		OnContainer: Color{R: 0xd6, G: 0xe3, B: 0xff, A: 0xff},
	}
}
