...
- Pin `github.com/Nomadcxx/sysc-wayland@v0.2.2`; do not import `dankgo` from shell code. Current pins for every consumed module are in `go.mod` and the README table.
