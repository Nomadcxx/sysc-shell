...
| `2026-09-13-bluetooth-panel.md` | plan | `sysc-155`: ten slices from post-network reconciliation through the BlueZ reducer, single-slot pairing, Registry relay, glyphs/widget, shared body, standalone panel, and the mandatory functional control-centre page. The issue cannot close on standalone work alone. |
