...
| `2026-09-02-project-state-and-remaining-work-handover.md` | project-handover | Whole-project state at `3159318`: milestone table M0-M8, conventions, environment, dependency and sibling-repo state, M6 in flight, M7 and M8 not started, and the remaining work in the order worth doing. |
