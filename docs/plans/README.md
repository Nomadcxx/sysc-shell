...
| `2026-09-17-centre-clock-media-wordmark.md` | plan | Live. Six test-first tasks for the default time/date group, absent-media collapse, anchored `ArrangeBar` placement, stable actions, and the DP-1 gate for `sysc-314`. |
