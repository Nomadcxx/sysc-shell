...
| `2026-09-06-launcher-chrome-remainder-handover.md` | execution-handover | Commissions the tail of the launcher design pass: DMS 12/16 row spacing, a clear button in the search field, and the rail slash weight (owner decision). Row hover already shipped in `21368a0`. Beads `sysc-193`. |
