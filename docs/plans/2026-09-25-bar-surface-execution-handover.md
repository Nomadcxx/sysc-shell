...
| Branch | PR | Contents |
|---|---|---|
| `claude/charming-dijkstra-ako8z4` | #13 | Centre pill (`6eec0d4`), its design, the bar-surface design, owner fix `294c708`. **Its tip was left at `3f5c2fa`** (Phase A pushed there by mistake); reset it to `294c708` before merging, or close #13 in favour of #15. |
| `claude/bar-surface-phase-a` | #15 | Everything in #13, the launcher/clipboard amendment, and Phase A (Tasks 1–4, `0d93063`..`3f5c2fa`). |

Start Phase B from `claude/bar-surface-phase-a` (or from `main` once #15 has
merged).
...
- Bar survey mockups: <https://claude.ai/artifact/JwBJ1YDCrUt62Skpm1Jdsa>
- Centre pill mockups and shell render comparison:
